...
const PatientDetails = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900">
      <SlideNavbar/>
      {/* Main Content */}
      <div className="flex-1" style={{backgroundColor: '#E3F2FD'}}>
        {/* Header */}
        <HeaderNavbar/>
        {/* Content Area */}
        <div className="p-6">
            ...
            <div className="flex-1">
              ...
              <div className="relative mb-6">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 bg-gray-200 rounded-lg border-none outline-none text-gray-700" style={{backgroundColor: '#E3F2FD'}}
                />
                ...
                {patients.map((patient) => (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <div className="w-16 h-16 bg-gray-100 rounded-full mb-3 overflow-hidden">
                        <img
                          src={patient.image}
                          alt={patient.name}
